...
public class CallLogApp {
    ...
    public CallLogApp(Boolean insertToDB) {
        ...
        if (insertToDB) {
            ...
            CallLogDAO callLogDAO = new CallLogDAO("jdbc:mysql://127.0.0.1/CallLogDB?useUnicode=true&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC", "root", "");
