...
public class CallLogBean implements Comparable<CallLogBean> {
    ...
    public CallLogBean(Integer id, String naam, Date datum, String bedrijf, String omschrijving, int prio, CallLogStatus status) {
        this.id = id;
        this.naam = naam;
        this.datum = datum;
     ...
     */
    @Override
    public int compareTo(CallLogBean callLog) {
